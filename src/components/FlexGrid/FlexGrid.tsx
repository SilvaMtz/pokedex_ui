import React, { HTMLAttributes, ReactNode, FunctionComponent, forwardRef } from "react";
...
> = forwardRef<HTMLElement, FlexGridProps>(({
  children,
  className,
  gutterSize = "l",
  direction = "row",
  ...
  return (
    ...
    <Component ref={ref} className={classList.join(" ")} {...rest}>
      {children}
    </Component>
  );
});
