...
import React, { CSSProperties, forwardRef, FunctionComponent, HTMLAttributes } from 'react';
...
export const FlexItem: FunctionComponent<FlexItemProps & HTMLAttributes<any>> = forwardRef<HTMLElement, FlexItemProps>(({
  children,
  className,
  grow = true,
  ...
  let classList = [
	...
	const componentInstance = (
		...
		<Component ref={ref} className={classList.join(' ')} style={style} {...rest}>
      {children}
    </Component>
	);
